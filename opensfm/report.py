...
class Report:
    ...
    def make_title(self) -> None:
        ...
        self.pdf.cell(0, self.margin, "Polardot Photogrammetry Quality Report", align="C")
        ...
        self.pdf.set_text_color(*self.mapi_dark_grey)
        self.pdf.cell(
            0, self.margin, f"Processed with Polardot Photogrammetry Version 1.0.0", align="R"
        )
